  ...
  const list = (anchor) => (
    ...
    >
        <Container>
            ...
            <Grid container>
              ...
              <Grid container>
                <Grid item p={1} lg={5} xs={12} md={12}>
                  <FormControl      sx={{ minWidth: { lg: 220, xs: 200, sm: 160, md: 160 } }} size="small">
            ...
            <Grid container>
              ...
              <Grid item m={1} lg={12} xs={12}>
                <FormControl
                    sx={{ minWidth: { lg: 220, xs: 200, sm: 160, md: 160 } }}
                    size="small"
                    >
                  <InputLabel id="demo-simple-select-autowidth-label">
        ...
        <Grid item p={1} lg={3} xs={3} sm={3} md={3}>
          <Box
            sx={{
              width: { lg: "80%", xs: "13rem", sm: "100%", md: "80%" },
              height: { lg: "18rem", xs: "15rem", sm: "29rem" },
